    ...
    def test_scaffold_creates_agent_baseline_without_bash(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for relative_path in ["AGENTS.md", "AI_BOOTSTRAP.md", "CLAUDE.md"]:
                ...
                self.assertIn("GRAPHIFY_AGENT_GOVERNANCE.md", instructions)
                self.assertIn("graphify-out/graph.json", instructions)
                self.assertIn("graphify update . --no-cluster --force", instructions)
